# AFTER DEPORTATION
## The Complete Truth Report on Trump‑Era Removals, DACA’s Crisis, and the Reintegration of Deportados and Dreamers in Mexico

### A Nonpartisan, Evidence‑First Flagship Report from The Mexico Deportee Coalition
...
My name is Paul Green. I grew up a country boy in North Carolina, in a family where faith, hard work, and showing up for people in hard times were not ideas but habits. In 2017, I packed up my life in the United States and came to Mexico, landing in Guanajuato for what I thought would be a temporary adventure. Somewhere between watching the sun set over the tunnels, getting lost in the alleys, and being welcomed into ordinary daily rhythms, that “temporary adventure” quietly became home. [web:273]

Since late 2020 and early 2021, I have run a small, low‑cost business helping people relocate to Mexico and helping those already here make sense of visas, neighborhoods, and everyday realities. Over these years I have talked with countless would‑be movers and new arrivals. Watching them build full, joyful lives in Guanajuato and beyond has been one of the most rewarding experiences of my life; it means being a tiny part of someone else’s success story, not just my own. The service is simple in design but deep in content: hard‑earned knowledge, personal experience, and years of building networks and asking questions about what it really takes to move to Mexico and thrive. [web:273]

Unlike high‑priced facilitators who charge hundreds of dollars to answer basic questions, I have tried to keep my support accessible and grounded in real life. Much of what I share is about culture and history, local events, and the small details of daily life that make Guanajuato feel like home rather than a beautiful backdrop. I manage a Facebook community (“Guanajuato Expats, Guanajuatenses, and Visitors”) and a Skool community called “Wonderful Guanajuato,” where I write guides and essays about this city that has given me so much joy, wonder, and apapacho. [web:273]

Alongside all of that, another reality has become impossible to ignore: deportees returning to Mexico from the United States, often with U.S. citizen children, broken families, and no clear next step. They are in border shelters and small interior towns, on buses and in factories, in call centers and in informal jobs. Many are scared, disoriented, and grieving. Too often, they are invisible or reduced to a statistic. [web:218][web:273]

The Mexico Deportee Coalition is my attempt to respond to that reality with the tools I have: words, relationships, and stubborn hope. I am a conservative, southern, Christian, white man from the United States who now calls Mexico home; part of what moves me is knowing that not all Americans believe deportees are unwelcome, disposable, or beyond redemption. Deportees deserve dignity, opportunity, and a real chance to rebuild. Getting deported is often catastrophic in the short term, but for those who are ambitious and willing to adapt, it does not have to be the end of their story. In some cases, it can become another kind of cross‑border success story, not so different from the voluntary moves I have helped people make for years. [web:273]

For years I have helped people—with options, passports, and resources—move to Mexico by choice and build good lives here. The deportees this report is about rarely had the luxury of choice, planning, or a soft landing. My hope is that, over time, this coalition can help change that: a cross‑border, cross‑culture effort, a deportee support network that is actually connected—the “Deportee Directory”—and eventually a podcast where deportees and their families can speak for themselves about what happens when a life is ripped out from under them, and how they build again. [web:205][web:218]

I expect to be just one of many members in this coalition, not its center. My role is to help remind deportees that they are not alone, that there are people they have never met who carry real sympathy and real hope for them. Not all Americans believe they are unwanted—even people from the South like me. This report is one way of saying exactly that.
...
- [Front Matter](#front-matter)  
  - [About The Mexico Deportee Coalition](#about-the-mexico-deportee-coalition)  
  - [How to Read This Report](#how-to-read-this-report)  
  - [Methods and Limitations: How This Report Was Conducted](#methods-and-limitations-how-this-report-was-conducted)  
  - [Key Messages: For Donors, Policymakers, and Journalists](#key-messages-for-donors-policymakers-and-journalists)  
- [Part One: Historical Architecture and Policy Evolution](#part-one-historical-architecture-and-policy-evolution)  
- [Part Two: Who Is Being Deported](#part-two-who-is-being-deported)  
- [Part Three: The Detention Crisis](#part-three-the-detention-crisis)  
...
The Mexico Deportee Coalition (TMDC) is a nonpartisan organization dedicated to documenting the reality of deportations, supporting communities affected by enforcement, and advancing policy solutions grounded in evidence rather than politics. Operating at the intersection of the United States and Mexico, TMDC seeks to understand what actually happens when the U.S. deports people—not what politicians claim happens, but what evidence shows. [web:273][web:263]

**Our Mission**: To generate rigorous, independent research on deportation policies and their impacts; to amplify the voices and experiences of affected communities; and to advocate for policies that prioritize human dignity, family unity, and evidence‑based solutions. [web:273]

**Our Values**:  
- **Truth above politics**: Report what data show, regardless of which administration initiated policies. [web:293]  
- **Evidence first**: Ground every major claim in verifiable data, academic research, or documented government records. [web:263][web:346]  
- **Human dignity**: Center the voices and humanity of those affected by deportation. [web:4][web:218]  
- **Accountability**: Document abuses, costs, and failures without regard to political affiliation. [web:11][web:271]  
- **Solutions focus**: Identify what works and what could work better, in both the United States and Mexico. [web:273][web:205]
...
**What This Report Is**:  
- A comprehensive, evidence‑based analysis of Trump‑era deportation policies in the second administration (2025–present) and their impacts across multiple dimensions. [web:14][web:9][web:11]  
- An integrated examination of both undocumented immigrant removals and the unfolding crisis facing DACA recipients and other long‑term residents with precarious legal status. [web:232][web:292][web:294]  
- A synthesis of U.S. and Mexican government data, peer‑reviewed research, organizational reports, and ground‑level observations in Mexican communities receiving deportees. [web:263][web:273][web:261][web:205]  
- A nonpartisan factual document designed to inform policy decisions, public understanding, and early‑stage philanthropic and community responses. [web:293]  
- A resource for policymakers, researchers, advocates, deportees, families, faith communities, and donors seeking to respond in concrete, constructive ways.

**What This Report Is NOT**:  
- A partisan attack on any administration or a defense of any political party. [web:293]  
- A prediction of exact future deportation totals, which depend on policy, budgets, court rulings, and broader economic conditions. [web:341]  
- A comprehensive legal guide or substitute for individualized legal counsel.  
- A replacement for the testimony and leadership of deportees themselves; rather, it is intended to clear space and provide context for those voices.

**How Sources Are Used**:  
- Major claims are backed by at least one credible source, such as U.S. agency data, Mexican government statistics, peer‑reviewed studies, or recognized advocacy and research organizations. [web:263][web:346][web:261][web:273]  
- Where official figures and independent estimates diverge—for example around the true number of removals, the composition of the detained population, or the capacity of Mexico’s “México te abraza” program—the report presents both and explains likely reasons for the gap (definitions, timeframes, methodology, or politics). [web:14][web:9][web:205][web:218][web:298]  
- When evidence is incomplete or contested, findings are framed cautiously, and the uncertainty is highlighted so readers understand where the ground is firm and where it is still shifting.

**Data Currency**: The analysis reflects information available through December 2025, including ICE and CBP data releases analyzed by journalists and researchers, updated DACA status explainers, and recent assessments of Mexico’s reception and reintegration strategies. [web:9][web:14][web:232][web:292][web:273][web:218]

---

### Evidence and Neutrality

This report takes positions on facts, not parties. Wherever possible, it compares deportation, detention, and DACA trends across multiple administrations using the best available figures from official U.S. and Mexican sources, independent monitoring projects, and peer‑reviewed work. [web:263][web:346][web:294][web:273]
...
From the perspective of projects like The Mexico Deportee Coalition, this means that supporting Dreamers cannot stop at helping with paperwork or job searches if deportations increase. It will also require spaces—support groups, mentorship programs, storytelling platforms, and cross‑border communities—where people can reconstruct identities that honor both where they came from and what they have lived through. [web:574][web:582] The “Deportee Directory” and a future podcast featuring deportees and Dreamers are not just media projects; they are tools for collective identity work, a way to insist that these lives are more than case numbers in any government database.
...
- **Dedicated credential‑recognition tracks** for returnees educated in U.S. schools and universities, with streamlined processes, clear timelines, and reduced fees. [web:629][web:644]  
- **Targeted job‑matching and entrepreneurship programs** that connect Dreamers’ skills—language, technology, teaching, health care—with real opportunities in Mexican labor markets, rather than defaulting to low‑wage, low‑skill placements. [web:618][web:641]  
- **Binational mental‑health initiatives** that train providers on the specific experiences of deported Dreamers and offer low‑cost counseling, peer support groups, and crisis hotlines in high‑return regions. [web:639][web:646]
...
- **Refocus enforcement on genuine public‑safety threats** by tailoring priorities to people who pose serious risks, rather than sweeping in parents, long‑term workers, and Dreamers who have grown up in the United States. [web:602][web:676]  
- **Create durable status for long‑settled residents**, including DACA recipients and other mixed‑status families, through legislation that provides a path to citizenship and removes the constant threat of removal from people who are already woven into U.S. communities. [web:552][web:544][web:694]  
- **Guarantee access to legal representation and due process** in immigration proceedings so that life‑altering decisions are not made in assembly‑line hearings where most people lack attorneys. [web:11][web:676]  
...
For communities, deportees, and Dreamers themselves, the call is to keep building the networks of solidarity that have always been the real counterweight to humiliation and isolation: rapid response teams, mutual‑aid projects, shelters, study groups, advocacy campaigns, and, now, coalitions like TMDC that explicitly link life in the United States to life after deportation in Mexico. [web:485][web:498][web:606] The choices made in the next few years will determine whether mass deportation remains a looming threat or becomes a lived reality for millions. This report is one contribution to making those choices as honest, informed, and humane as possible.

---

# Appendix A: Key Statistics Table

> These figures are compiled from multiple reports and are approximate ranges meant to orient the reader, not replace detailed technical documentation.

| Indicator | Approximate value / range | Notes |
| --- | --- | --- |
| Undocumented immigrants in the U.S. | About 10–11 million people [web:11][web:694] | Concentrated in several states; many are long‑term residents. |
| Undocumented workers in the labor force | Roughly 7–8 million workers [web:672][web:690] | High participation in agriculture, construction, hospitality, and care work. |
| Active DACA recipients (2025) | Just over 500,000 people [web:294][web:232] | Average age late 20s–early 30s; many have lived 20+ years in the U.S. |
| U.S. citizen children with at least one undocumented parent | About 5–6 million children [web:420][web:24] | Highly vulnerable to detention and deportation of caregivers. |
| Estimated annual tax contributions of undocumented immigrants | Around $90–100 billion in combined federal, state, and local taxes [web:424][web:690][web:686] | Includes payroll, income, property (direct and via rent), and sales taxes. |
| Projected GDP impact of nationwide mass deportation | Multi‑hundred‑billion‑dollar reduction over a decade [web:672][web:661][web:692] | Modeling suggests significant job and output losses even for citizens. |
| Share of deportees with U.S. citizen children | Often one‑quarter to one‑third of interior removals in studied samples [web:24][web:420] | Exact rates vary by time period and enforcement priorities. |
| Number of Mexicans deported or returned from the U.S. annually (recent years) | On the order of several hundred thousand per year, depending on policy and migration flows [web:422][web:640] | Includes formal removals and other return mechanisms. |
| Documented mental‑health impacts on children facing parental detention/deportation | Elevated rates of anxiety, depression, PTSD‑like symptoms, and school difficulties [web:24][web:4][web:684] | Effects can persist into adulthood and influence long‑term outcomes. |

---

# Sources and References

This report draws on a wide range of research and documentation, including:

- **Psychological and family impacts of enforcement and deportation**: clinical and policy statements, longitudinal studies, and mixed‑methods research on how detention and removal affect children’s mental health, family functioning, and community well‑being. [web:24][web:4][web:406][web:420][web:684]  
- **Detention conditions and public‑health consequences**: investigations of immigration detention facilities, analyses of health outcomes linked to detention and return migration, and evaluations of alternatives to detention. [web:261][web:636][web:506][web:684]  
- **Economic and fiscal effects of mass deportation and expanded enforcement**: modeling of GDP, employment, and tax impacts at national and state levels; sector‑specific analyses; and reviews of how enforcement trajectories intersect with labor markets. [web:103][web:661][web:672][web:686][web:692][web:695]  
- **DACA and Dreamers**: demographic and economic profiles, health studies, and work on identity and belonging among DACA recipients and other members of the 1.5 generation. [web:294][web:544][web:552][web:557][web:575]  
- **Return, reintegration, and Mexico’s reception systems**: reports on “México te abraza,” budget and policy analyses, and qualitative and quantitative work on return migration, reintegration challenges, and local impacts in Mexican communities. [web:422][web:499][web:504][web:618][web:628][web:639][web:640]  
- **Policy blueprints and critiques of mass‑deportation agendas**: assessments of Project 2025 and related proposals, legal and civil‑rights analyses, and policy briefs outlining alternative enforcement and legalization strategies. [web:11][web:172][web:657][web:659][web:676]  
- **Community and civil‑society responses**: documentation of rapid response networks, legal defense funds, sanctuary and safe‑campus policies, and cross‑border faith and humanitarian initiatives. [web:485][web:489][web:495][web:662][web:498][web:606]

Readers seeking more technical detail on specific statistics or studies are encouraged to consult these underlying sources directly, using them as starting points for deeper exploration of the evidence behind each section of this report.


---

## Toward Solutions: From Crisis to Coalition

The chapters so far have traced how policy decisions in Washington and Mexico City reverberate through detention centers, living rooms, schoolyards, and job sites on both sides of the border. The question that follows is what can be done—not only by governments, but by communities, organizations, and individuals who refuse to accept humiliation and isolation as the last word for deportees and Dreamers. [web:2][web:392][web:205] The remaining sections of this report explore existing forms of resistance, outline practical steps toward a more humane system, and sketch the role that a cross‑border initiative like The Mexico Deportee Coalition—and projects such as a “Deportee Directory” and story‑driven podcast—might play in that larger ecosystem.





> #### Join and Strengthen This Coalition  
> If this report resonates with you and you want to stand with deportees rebuilding lives in Mexico, you can:  
> - **Join the coalition:** https://mexicodeporteecoalition.org/join  
> - **Contribute to our startup fund:** https://givebutter.com/mexicodeporteecoalitionstartup  
> - **Learn more and share our work:** https://mexicodeporteecoalition.org  
>  
> **Important:** At this early stage, TMDC is still establishing its legal structure and applying for 501(c)(3) status in the United States. Any financial contributions are voluntary and will be used to help design, launch, and stabilize this project, but **are not tax‑deductible at this time**. Once nonprofit status is secured, future contributions may qualify as charitable gifts under applicable law, but no guarantees can be made here and nothing in this report constitutes legal, financial, or tax advice. [web:293]
